...
var ProjectWhere = struct {
	...
	Number: whereHelperint{field: "`projects`.`number`"},
...
func (o *Project) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for projects")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for projects")
	}
