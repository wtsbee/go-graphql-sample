...
func (o *Repository) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for repositories")
	}
...
func (o *Repository) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for repositories")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for repositories")
	}
