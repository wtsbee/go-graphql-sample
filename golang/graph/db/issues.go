...
var IssueWhere = struct {
	...
	Closed:     whereHelperbool{field: "`issues`.`closed`"},
...
func (o *Issue) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for issues")
	}
...
func (o *Issue) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for issues")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for issues")
	}
